...
st.set_page_config(page_title="Stock Market", page_icon=":bank:", layout="wide")
# Definindo as opções para o radio button
options = ['Home', 'User Manual']
...
if choice == 'Home':
    ...
    st.write("---")
    st.image("images/7.png", width=1500)
    st.write("---")
    st.image("images/8.png", width=1500)
else:
